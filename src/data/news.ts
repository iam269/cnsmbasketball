...
Comportamentul nesportiv poate fi sancționat.`,
  ...
  },
  {
    ...
    excerpt:
      "Descoperă regulile oficiale FIBA 3x3: teren, jucători, sistem de punctaj, 12 secunde, check-ball și cum se câștigă un meci.",
    content: `
1. 🏀 Principiile jocului
1.1. Definiția jocului
FIBA 3x3 se joacă între două echipe.
Fiecare echipă are 3 jucători pe teren.
Fiecare echipă poate avea un substitut.
Jocul se desfășoară pe jumătate de teren, cu un singur coș.
Scopul este înscrierea unui număr mai mare de puncte decât adversarul.
1.2. Scopul jocului
O echipă poate câștiga:
prin atingerea pragului de 21 de puncte înainte de expirarea timpului regulamentar;
sau prin faptul că are mai multe puncte decât adversarul la finalul celor 10 minute.
2. 🏟️ Terenul
2.1. Dimensiuni
Terenul oficial 3x3 are:
15 m lățime
11 m lungime
un singur coș;
linia de 3 puncte a terenului standard este utilizată ca arc de 3x3.
2.2. Zone importante
Terenul include:
zona de joc;
arcul de 2 puncte;
zona de restricție;
linia de aruncări libere;
liniile de fund și laterale;
zona din afara arcului.
3. 👥 Echipele
Fiecare echipă este formată din:
3 jucători + 1 substitut = maximum 4 jucători.
3.1. Jucătorii
La începutul meciului trebuie să existe:
3 jucători activi pentru fiecare echipă;
substitutul trebuie să fie eligibil conform competiției.
3.2. Antrenorul
În competițiile FIBA 3x3 oficiale, coaching-ul în timpul competiției nu este permis în forma prevăzută de regulile competiției. Antrenorii pot însă participa la pregătirea echipelor înaintea competiției.
4. ⏱️ Durata jocului
4.1. Timp regulamentar
Un meci oficial durează:
10 minute.
Cronometrul se oprește în situațiile de minge moartă și pornește conform procedurii de reluare a jocului.
4.2. Victoria înainte de final
Dacă o echipă ajunge la:
🏆 21 DE PUNCTE
înainte de expirarea celor 10 minute, jocul se încheie imediat, iar acea echipă câștigă.
5. ⚡ Prelungirea
Dacă scorul este egal după cele 10 minute:
se intră în prelungiri;
nu există o durată fixă pentru overtime;
prima echipă care înscrie 2 puncte câștigă.
6. 🎯 Sistemul de punctaj
În 3x3 există două valori principale.
🟢 1 punct
Se acordă pentru:
coș înscris din interiorul arcului;
aruncare liberă reușită.
🔵 2 puncte
Se acordă pentru:
coș înscris din exteriorul arcului.
Astfel:
Interiorul arcului = 1 punct
Exteriorul arcului = 2 puncte
7. 🏀 Mingea
Pentru competițiile oficiale FIBA 3x3 se utilizează mingea specifică 3x3, de mărimea 6, cu circumferința corespunzătoare formatului 3x3. FIBA indică utilizarea mingii de size 6 pentru competițiile 3x3.
8. 🔄 Începerea jocului
Jocul începe printr-o procedură de check-ball.
Procedura:
Mingea este transmisă de echipa aflată în apărare.
Mingea ajunge la echipa aflată în atac.
Jucătorii trebuie să respecte pozițiile regulamentare.
După primirea mingii, începe cronometrul.
Această procedură este utilizată și pentru reluarea jocului după situațiile de minge moartă.
9. 🔁 Check-ball
Check-ball-ul este una dintre cele mai importante reguli ale 3x3.
În general:
Apărare → pasează mingea → atac → începe jocul.
După o situație de minge moartă, jocul este reluat prin check-ball.
Check-ball-ul se efectuează în zona din afara arcului, conform procedurii regulamentare.
10. 🔥 După un coș reușit
După înscrierea unui coș:
echipa care a primit coșul preia mingea;
nu există repunere clasică de sub coș ca în 5x5;
jocul continuă rapid;
mingea trebuie dusă în spatele arcului înainte ca echipa să poată ataca regulamentar.
11. 🔄 Schimbarea posesiei
Una dintre diferențele majore față de baschetul 5x5 este că după un coș înscris, echipa care a primit coșul continuă jocul cu posesia mingii.
Jocul este conceput pentru tranziții rapide și schimbări continue între atac și apărare.
12. ⏱️ Cronometrul de atac – 12 secunde
Echipa aflată în atac are:
12 SECUNDE
pentru a încerca un șut.
Dacă echipa nu efectuează o încercare regulamentară înainte de expirarea timpului:
→ posesia revine adversarului.
Acesta este unul dintre elementele care fac 3x3 mult mai rapid decât baschetul tradițional.
13. 🔄 Mingea trebuie scoasă în afara arcului
După ce echipa câștigă posesia în anumite situații, mingea trebuie scoasă în spatele arcului înainte ca echipa să poată încerca regulamentar un atac.
Această regulă este esențială pentru alternarea atacului și apărării.
14. 🚨 Abateri
Printre cele mai importante abateri se numără:
Traveling
Deplasarea ilegală cu mingea.
Double Dribble
Reluarea ilegală a driblingului.
Out of bounds
Mingea sau jucătorul ajunge în afara terenului.
Shot-clock violation
Echipa nu încearcă un șut în cele 12 secunde.
Ball not cleared
Mingea nu este dusă în afara arcului atunci când regulamentul o cere.
15. 🤝 Greșelile
La fel ca în baschetul 5x5, contactele ilegale pot fi sancționate.
Exemple:
împingere;
ținere;
lovire;
...
contact ilegal;
comportament nesportiv.
În 3x3 există însă un sistem specific de sancționare a greșelilor, adaptat formatului rapid al jocului.
16. 🟨 Greșelile de echipă
Greșelile echipei sunt contabilizate pe durata jocului.
Pe măsură ce numărul lor crește, sancțiunile devin mai severe conform regulilor FIBA 3x3.
17. 🎯 Aruncările libere
O aruncare liberă reușită valorează:
1 punct.
Jucătorul trebuie să execute aruncarea în timpul regulamentar prevăzut.
FIBA precizează că executantul aruncării libere trebuie să efectueze aruncarea în maximum 5 secunde.
18. 🔄 Înlocuirile
Fiecare echipă poate avea un singur substitut.
Înlocuirea:
se realizează în timpul unei situații de minge moartă;
substitutul intră din zona regulamentară;
jucătorul care iese trebuie să efectueze contactul fizic („tag up”) cu substitutul.
19. ⏸️ Time-out
În formatul oficial FIBA 3x3, echipele au posibilitatea de a solicita time-out conform regulamentului.
Time-out-ul este utilizat pentru:
odihnă;
organizarea echipei;
strategie;
oprirea temporară a jocului.
20. 🧑‍⚖️ Oficialii
Un meci FIBA 3x3 este gestionat de oficialii desemnați pentru competiție.
...
controlul desfășurării jocului.
FIBA are un program separat de dezvoltare și certificare pentru oficialii 3x3.
21. ⚠️ Comportamentul nesportiv
Jucătorii trebuie să respecte:
adversarii;
arbitrii;
organizatorii;
colegii;
regulile competiției.
Comportamentul agresiv sau nesportiv poate atrage sancțiuni conform regulamentului.
22. 🏆 Cum se câștigă un meci
Există trei scenarii principale:
🥇 Scenariul 1
O echipă ajunge la 21 de puncte înainte de expirarea celor 10 minute.
→ Acea echipă câștigă.
🥈 Scenariul 2
Cele 10 minute expiră.
→ Câștigă echipa cu mai multe puncte.
🥉 Scenariul 3
Scor egal după 10 minute.
→ Se joacă overtime.
→ Prima echipă care înscrie 2 puncte câștigă.
📌 Cele mai importante reguli 3x3
Pentru site, aș face și un card vizual cu regulile pe care orice jucător trebuie să le știe:
Regulă	FIBA 3x3
👥 Jucători	3 + 1 substitut
🏟️ Teren	15 × 11 m
🏀 Coș	1
⏱️ Meci	10 minute
🏆 Limită victorie	21 puncte
⚡ Shot clock	12 secunde
🟢 Coș în interior	1 punct
🔵 Coș exterior	2 puncte
🎯 Aruncare liberă	1 punct
🔥 Overtime	Prima echipă la +2 puncte
🔄 Substituții	În situație de minge moartă
🏀 Minge	Size 6
Informațiile de bază din tabel sunt conform prezentării oficiale FIBA 3x3.`,
    image: null,
  },
];
